...
![avatar](https://github.com/zhangjf23/zhangjf23.github.io/blob/master/_posts/pictures/1.jpg)

如果把相邻的x和y两个token合并生成一个新的token叫做z，那么整个句子likelihood的变化可以用下面的式子来表达：
![avatar](https://github.com/zhangjf23/zhangjf23.github.io/blob/master/_posts/pictures/2.jpg)
